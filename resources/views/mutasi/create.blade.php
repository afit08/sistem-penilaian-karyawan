...
<div class='row'>
    ...
    <h4 class='widget-title'>FORM TAMBAH DATA MUTASI</h4>
	...
	<div class='col-xs-12 col-sm-9'>
    <div class='clearfix'>
    <select name='tahun_penilaian_id' id="tahun_penilaian_id" >
    @foreach ($tahun_penilaian as $item)
    <option value="{{ $item->id }}">{{ $item->nama_tahun_penilaian }}</option>
    @endforeach
    </select>
    </div>
    </div>
