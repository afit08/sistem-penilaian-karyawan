...
class AdminController extends Controller 
{
    ...
    public function index(){
        $user = User::with('Divisi')->where('divisi_id','<','15')->get();
        return view('karyawan.index', compact('user'));
    }

    public function detail($id){
        $user = User::with('Divisi')->get()->where('id',$id);
        return view('karyawan.detail', compact('user'));
    }
    ...
    public function store(KaryawanRequest $request)
    {
        ...
        return redirect('karyawan')->with('success','Data Karyawan Berhasil Dibuat.');
    }
    ...
    public function edit($id)
    {
        ...
        $divisi = Divisi::all();
        return view('karyawan.edit',['user' => $user], compact('divisi'));
    }
