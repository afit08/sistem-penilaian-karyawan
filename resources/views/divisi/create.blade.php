...
<div class='row'>
    ...
    <form class='form-horizontal' method="POST" action="{{ route('save-divisi') }}">
    {{ csrf_field() }}
    ...
    <div class='form-group'>
        <label class='control-label col-xs-12 col-sm-3 no-padding-right' for='name'>Divisi :</label>
	        <div class='col-xs-12 col-sm-9'>
                <div class='clearfix'>
                <input type='text' id='divisi' name='divisi' class="input-sm col-xs-12 col-sm-8 @error('divisi') is-invalid @enderror" maxlength='100' value="{{ old('divisi') }}"/>
                </div>
            </div>
    @error('divisi')
